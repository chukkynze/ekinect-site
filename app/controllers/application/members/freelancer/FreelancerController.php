...
class FreelancerController extends AbstractFreelancerController
{
    ...
    public function showDashboard()
    {
		 ...
		 *
         *
         * 'TODO_footerLink'            =>    '/freelancerTasks',
...
* 'taskProgressBarIsComposite'		=>	FALSE, // The DISPLAY of this one task is broken into bits that add up to taskOverallCompletionLevel
		...
		$memberUserMenuArray	=	array
									(
										...
										array
										(
											'link'			=>	'/freelancerAccountSettings',
											'iconClass'		=>	'fa fa-cog',
										...
										array
										(
											'link'			=>	'/freelancerPrivacySettings',
											'iconClass'		=>	'fa fa-eye',
        ...
        $viewData   =   array
                        (
                             ...
                             * INBOX Dropdown Variables
                             */
                            'INBOX_sidebarLink'  					=> 	'/freelancerInbox',
                            'INBOX_sidebarLink_all'  				=> 	'/freelancerInbox/all',
                            'INBOX_sidebarLink_new'  				=> 	'/freelancerInbox/new',
                            'INBOX_sidebarLink_favorites'  			=> 	'/freelancerInbox/favorites',
                            'INBOX_footerLink'  					=> 	'/freelancerInbox',
                            'INBOX_composeNewLink'  				=> 	'/freelancerInbox/ComposeNewMessage',
