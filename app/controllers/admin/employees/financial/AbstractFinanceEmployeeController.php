<?php
    /**
     * Class AbstractFinanceEmployeeController
     *
     * filename:   AbstractFinanceEmployeeController.php
     *
...
class AbstractFinanceEmployeeController extends AbstractEmployeeController
{
    use MemberControls;
