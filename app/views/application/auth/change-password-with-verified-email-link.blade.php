<?php
/**
 * filename:   change-password-with-verified-email-link.blade.php
 *
							...
							<div class="login-box-plain">
                                ...
                                {{ Form::open(array('method' => 'POST', 'action' => 'CustomerAuthenticationController@postChangePasswordWithVerifyEmailLink')) }}
                                    ...
                                    <div class="form-group">
                                        <?php echo Form::label('change_verify_member', 'Your Email Address'); ?>
                                        <i class="fa fa-envelope"></i>
                                        <?php echo Form::text('change_verify_member', '', array('class' => "form-control")); ?>
                                    </div>
                                    <div class="form-group">
